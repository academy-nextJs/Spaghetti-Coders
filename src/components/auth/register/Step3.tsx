            ...
            <article className="max-w-md w-full">
                ...
                <form action={formAction} className="mt-5 flex flex-col gap-3">
                    <CommonInput
                        ...
                        defaultValue={(actionState.payload.get('phoneNumber') || undefined) as string}
                        required 
                    />
                    {actionState ? <span className="text-red-400 text-sm mt-2">{actionState.message.phoneNumber}</span> : null}
                    <CommonInput
                        name="password"
                        type="password"
                        label="رمز عبور"
                        ...
                        required
                    />
                    {actionState ? <span className="text-red-400 text-sm mt-2">{actionState.message.password}</span> : null}
                    <CommonInput
                        name="passwordRepeat"
                        type="password"
                        ...
                        defaultValue={(actionState.payload.get('passwordRepeat') || undefined) as string}
                        required 
                    />
                    {actionState ? <span className="text-red-400 text-sm mt-2">{actionState.message.passwordRepeat}</span> : null}
