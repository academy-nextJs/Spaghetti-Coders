...
export const EmailStep = () => {
  const [actionState, formAction, isPending] = useActionState(registerEmail, {
    message: {},
  ...
  return (
    <article className="w-full flex flex-col justify-center max-w-md">
      ...
      <p className="text-sm text-[#767676] text-right mb-8">
        برای ثبت نام در آلفا میتوانید با اکانت گوگل یا اپل خود وارد شوید و یا با
        ارسال کد تایید به ایمیل خود اقدام کنید
      </p>
