  ...
  return (
    <div className="relative max-w-[300px] overflow-hidden">
      ...
      <div className="absolute top-2 left-2 z-10 flex items-center gap-1 text-sm font-medium text-white">
        ...
        {rating ? (
          <div className="bg-primaryPurple flex items-center rounded-full p-1">
      ...
      <div className="pt-3 flex flex-col gap-4">
        ...
        parking > 0 ? (
          <div
            className={`w-full flex flex-wrap items-center gap-3 font-medium ${Classes['flex-container']}`}
          >
            {bathroom > 0 ? (
          ...
          {originalPrice ? (
            <>
              <div className="relative flex items-end text-[#A6A6A6]">
                ...
                <span className="text-[0.8rem]/[0.8rem] text-[#A6A6A6] font-semibold">
                  تومان
                </span>
