...
// import { ClientCountUp } from "../../common/CountUp/ClientCountUp";
import Avatars from "./Avatar";

const ClientCountUp = dynamic(() => import('../../common/CountUp/ClientCountUp').then(mod => mod.ClientCountUp))
    ...
    <div className="w-full flex flex-row h-[12rem]  px-4 sm:px-6 md:flex-row gap-1 sm:gap-4 md:gap-5  justify-center mb-12 sm:mb-20 md:mb-32">
      <div className="w-full md:w-[12.44rem] h-auto md:h-[13.06rem] bg-[#F9F9F9] dark:bg-darkMode rounded-2xl sm:rounded-3xl p-4 md:mt-48 mt-4 sm:mt-6">
        ...
        <ClientCountUp 
          ...
          separator=''
          suffix=" +"          
          className="pl-2 md:pl-4 sm:text-3xl md:text-4xl pt-1 md:pt-3 font-semibold text-sm mt-1 md:mt-2"
        />
      ...
      <div className="w-full md:w-[12.5rem] h-auto md:h-[18.75rem]  bg-[#DFDFFF] rounded-2xl sm:rounded-3xl dark:bg-darkMode p-4 mt-3 sm:mt-4 md:mt-26">
        ...
        <ClientCountUp 
          ...
          separator=''
          suffix=" +"          
          className="sm:text-3xl md:text-4xl font-semibold pt-1 pl-2 text-sm md:pl-4 mt-1 md:mt-2 dark:text-white text-black text-right"
        />
      ...
      <div className="w-full md:w-[13.75rem] h-auto md:h-[23.9rem] bg-[#F9F9F9] rounded-2xl sm:rounded-3xl dark:bg-darkMode p-4 mt-3 sm:mt-4">
        ...
        <ClientCountUp 
          ...
          separator=''
          suffix=" +"          
          className="sm:text-4xl md:text-5xl font-semibold pt-1 pl-2 text-sm md:pl-4 mt-1 md:mt-2 dark:text-white text-black text-right"
        />
