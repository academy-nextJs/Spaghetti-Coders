...
export default function LandingCard2({ title, location, bathroom, bedroom, parking, yard, price, originalPrice, rating, discountPercentage }: HouseCardProps) {
  return (
    <div className="relative w-[300px] rounded-3xl overflow-hidden">
      <Image
        alt="Luxury apartment view"
        className="object-cover w-full h-1/2 rounded-3xl"
        src={Pic.src}
        width={300}
        height={280}
      />
            ...
            {originalPrice ?
              <>
                <div className='relative flex gap-1 items-end text-[#A6A6A6]'>
                  <span className="font-bold text-2xl ">{originalPrice}</span>
