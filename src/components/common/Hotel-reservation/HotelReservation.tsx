...
const HotelReservation = () => {
  return (
    <div className=" flex flex-col gap-4 w-[70rem]">
      <h1 className="font-bold text-xl  text-primaryPurple ">
        {' '}
        همین حالا رزرو کنید{' '}
      </h1>
      ...
      <div className="flex flex-row w-1/2 gap-4 ">
        ...
        <div className="flex flex-col font-bold gap-4 w-1/2">
          <span className="text-primaryPurple ">مجموع قیمت </span>
          <Price />
        </div>
      </div>
      <ClientButton className="bg-primaryPurple dark:bg-darkMode w-1/2 mt-4 text-white ">
        {' '}
        همین الان رزرو کن{' '}
      </ClientButton>
    </div>
