...
const SearchButton = () => {
    ...
    return (
        <>
            ...
            <button
                onClick={openModal}
                className="flex flex-col w-[6.25rem] h-[6.25rem]  items-center justify-center cursor-pointer border-4 border-amber-50 bg-[#7575FE] text-white rounded-full p-4 shadow-lg">
                <div>
