...
const FilterButton = () => {
    return (
        <button className="flex flex-col w-[60px] h-[60px] sm:w-[75px] sm:h-[75px] md:w-[90px] md:h-[90px] items-center justify-center cursor-pointer border-2 border-amber-50 bg-[#7575FE] text-white rounded-full p-2 sm:p-3 md:p-4 shadow-lg">
            <svg width="32" height="32" viewBox="0 0 32 32" className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-[10px] sm:text-xs mt-1">جستجوی سریع</span>
        </button>
    );
};
