...
export default function CategoryCarousel({ data }: { data: Category[] }) {
  return (
    <div className="relative w-full">
      <div className="absolute right-0 top-1/2 transform -translate-y-1/2 h-3/4 w-1/4 bg-gradient-to-r from-blue-100 to-transparent opacity-70 blur-3xl rounded-full z-0"></div>
