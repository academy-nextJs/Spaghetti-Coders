const FilterButton = () => {
    return (
        <button className="flex flex-col w-[90px] h-[90px] items-center justify-center cursor-pointer border-2 border-amber-50 bg-[#7575FE] text-white rounded-full p-4 shadow-lg">
