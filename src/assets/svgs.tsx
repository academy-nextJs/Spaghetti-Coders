...
export const CardSvg: React.FC = () => {
    return (
        <svg width="1" height="170" viewBox="0 0 1 199" fill="none" xmlns="http://www.w3.org/2000/svg">
            <line x1="0.5" y1="-2.18557e-08" x2="0.500009" y2="199" stroke="#D1D1D1" stroke-dasharray="5 5" />
        </svg>

    );
};

export const CardSvg2: React.FC = () => {
    return (
        <svg width="1" height="126" viewBox="0 0 1 126" fill="none" xmlns="http://www.w3.org/2000/svg">
            <line x1="0.5" y1="-2.18557e-08" x2="0.500005" y2="126" stroke="#BABAFF" stroke-dasharray="5 5" />
        </svg>
    );
};
